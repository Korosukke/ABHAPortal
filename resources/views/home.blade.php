...
<body class="h-full">
    ...
    <a href="{{ route('prescript', ['abha_number' => $user->abha_number]) }}" class="flex flex-col items-center w-96 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Prescriptions</h5>
        <div class="mb-3">
            <img src="{{ asset('/assets/notes.svg') }}" class="h-20 w-20 mx-auto">
        </div>
    </a>

    <a href="{{ route('showRecords', ['abha_number' => $user->abha_number]) }}" class="flex flex-col items-center w-96 p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
        <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Health Record</h5>
        <div class="mb-3">
            <img src="{{ asset('/assets/record.svg') }}" alt="Health Record" class="h-20 w-20 mx-auto">
        </div>
    </a>
</div>
