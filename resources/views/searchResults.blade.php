...
<body class="h-full">
    ...
    <h2 class="text-2xl font-bold mb-10">SEARCH MEDICAL RECORDS</h2>
        <form action="/showSearch" method="GET" class="w-full max-w-md">
            <div class="flex items-center">
                <input type="text" name="abha_number" class="border p-2 rounded-md mr-2 w-full" placeholder="Enter ABHA number">
                <button type="submit" class="bg-orange text-white px-4 py-2 rounded-md hover:bg-blue-700">Search</button>
            </div>
        </form>
    </div>
